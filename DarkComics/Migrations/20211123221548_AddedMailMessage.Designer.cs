...
namespace DarkComics.Migrations
{
    ...
    [Migration("20211123221548_AddedMailMessage")]
    partial class AddedMailMessage
    {
            ...
            modelBuilder.Entity("DarkComics.Models.Entity.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Blogger = "Tim Beedle",
                            CreatedDate = new DateTime(2021, 11, 24, 2, 15, 48, 143, DateTimeKind.Local).AddTicks(4221),
                            Image = "cover.jpg",
